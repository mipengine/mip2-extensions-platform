...
<div class="mint-msgbox-wrapper" style="position: absolute; z-index: 2001;">
  <div class="mint-msgbox">
    ...
    <div class="mint-msgbox-btns">
      <button class="mint-msgbox-btn mint-msgbox-cancel" button-type="cancel" style="font-size:0.9rem;${params.hasOwnProperty('showCancelButton') && params.showCancelButton ? '' : 'display: none'}">取消</button>
      <button class="mint-msgbox-btn mint-msgbox-confirm" button-type="confirm" style="font-size:0.9rem">确定</button>
    </div>
  </div>
</div>
