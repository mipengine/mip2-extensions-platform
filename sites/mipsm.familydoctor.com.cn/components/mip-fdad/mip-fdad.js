...
define(function (require) {
    ...
    function mipAdd(str, pid, cid) {
        ...
        customer.data.mips.push({pid: pid, domain: arr2[0], token: arr2[arr2.length-1]});
    ...
    var render = function (that, me, domain, token, url) {
        var self = that;
        ...
        if (domain && token) {
            ...
            script.src = '//kdewa111.familydoctor.com.cn/common/mh/static/znj/common/pq_d/production/p.js';
            ...
            success: function () {
                ...
                if (mipad) {
                    try {
                        ...
                        render(ele, me, mipad.domain, mipad.token, url);
                    } catch (e) {}
                }
            }
        });
