<template>
  <div class="scroll-container" v-show="scrollshow" @touchmove.prevent>
    <div class="scroll-select">
      <div class="scroll-header">
        <span @click="closeScrollSelect()" class="left">取消</span>
        <span class="right cfont" @click="getScrollSelectValue()">确定</span>
      </div>
