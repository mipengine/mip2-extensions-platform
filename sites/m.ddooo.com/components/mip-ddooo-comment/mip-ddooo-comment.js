...
export default class MIPMpc6Comment extends CustomElement {
  build () {
    ...
    let hClass = this.element.querySelectorAll('.ztheader .hClass')[0]
    let hKeyList = this.element.querySelectorAll('.ztheader .hKeyList')[0]
    let cKeyList = this.element.querySelectorAll('.hKeyList')[0]
    let cp = this.element.getElementsByTagName('.hKeyList p')[0]
    let cimg = this.element.getElementsByTagName('.ztheader img')[0]
    let ctent = this.element.getElementsByTagName('.ztheader .hContent')[0]
    window.addEventListener('click', window.onscroll = function () {
