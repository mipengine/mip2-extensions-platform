      ...
      let e = function (e, n) {
        ...
        W = function (e, n) {
          ...
          if (n.fonts.extendedJsFonts) {
            let r = ['Abadi MT Condensed Light', 'Academy Engraved LET', 'ADOBE CASLON PRO', 'Adobe Garamond',
          ...
          let i = 'mmmmmmmmmmlli',
            ...
            p = function (e) {
              for (let n = !1, a = 0; a < t.length; a++)
                if (n = e[a].offsetWidth !== u[t[a]] || e[a].offsetHeight !== d[t[a]], n) return n
              return n
            },
            T = h()
          l.appendChild(s)
          for (let v = 0, A = t.length; v < A; v++) u[t[v]] = T[v].offsetWidth, d[t[v]] = T[v].offsetHeight
          let w = m()
          l.appendChild(c)
        ...
        K = function (e) {
          ...
          if (Object.getOwnPropertyDescriptor && Object.getOwnPropertyDescriptor(window, 'ActiveXObject') ||
            ...
            let t = ['AcroPDF.PDF', 'Adodb.Stream', 'AgControl.AgControl', 'DevalVRXCtrl.DevalVRXCtrl.1',
        ...
        ie = function() {
          ...
          try {
            let f = e.getExtension('WEBGL_debug_renderer_info')
        ...
        de = function() {
          ...
          if (e = n.indexOf('firefox/') >= 0 ? 'Firefox' : n.indexOf('opera/') >= 0 || n.indexOf(' opr/') >= 0 ? 'Opera' :
            ...
            '20030107' !== t) return !0
          let a, r = 'function eval() { [native code] }'.toString().length
    ...
    function (e, n) {
      function t(e) {
        e.request = location.href, e.referrer = document.referrer, e.agent = navigator.userAgent, s && console.log('fp2',
          e), e = e || {}, e._ = +new Date
        let n = []
        for (let t in e) e.hasOwnProperty(t) && n.push(encodeURIComponent(t) + '=' + encodeURIComponent(e[t]))
        let a = u + (~u.indexOf('?') ? '&' : '?') + n.join('&'),
          r = new Image
      ...
      function r(e, n) {
        ...
        let a = RegExp('(^|s|;)' + e + '=([^;]*)(;|$)').exec(document.cookie)
        return a ? a[2] : ''
      }
        ...
        Fingerprint2.get(function (t) {
          ...
          for (let r in t)
            if (t.hasOwnProperty(r)) {
              let o = t[r]
              a.push(o.value)
            } let l = Fingerprint2.x64hash128(a.join(), 31),
            s = new Date,
            u = s - n
          i(c, l), e && e({
            fingerprint: l,
