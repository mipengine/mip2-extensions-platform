  ...
  <div class="wrapper">
      <ul class="guideList">
          ...
          <li class="border-first">
              <p @click="open(qubie)" :class="{'open-detail':qubie.flag}">
                  <span>搬家和货运的区别</span>
                  <span class="arrow"></span>
              </p>
              <div v-show="qubie.flag" class="detail">
                货运为师傅仅为您提供从A地到B地的货物运输服务，如您需要师傅提供搬运服务需要与师傅协商价格；
                搬家为一口价的含搬运的搬家服务，除厢货涉及到部分额外大件费用外，其他价格均为一口价，价格透明，绝不会坐地起价。
              </div>
          </li>
            <li>
              <p  @click="open(youhui)" :class="{'open-detail':youhui.flag}">
                  <span>如何获得优惠</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="youhui.flag" class="detail">
          ...
          <li>
              <p  @click="open(sfbanyun)" :class="{'open-detail':sfbanyun.flag}">
                  <span>搬家师傅是否管搬运</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="sfbanyun.flag" class="detail">
                搬家订单师傅是提供全程搬运的，搬运的范围为一整车的搬运，一整车包含多趟往返，不单独按搬运次数计算。
              </div>
          </li>
           <li>
              <p  @click="open(cancel)" :class="{'open-detail':cancel.flag}">
                  <span>取消及退款问题</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="cancel.flag" class="detail">
           ...
           <li>
              <p  @click="open(fapiao)" :class="{'open-detail':fapiao.flag}">
                  <span>如何开发票</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="fapiao.flag" class="detail">
                在线支付的费用，在订单服务完成后，可以在【个人中心】中找到【发票】，输入发票信息申请开票即可。
              </div>
          </li>
           <li class="border-second">
              <p  @click="open(safetousu)" :class="{'open-detail':safetousu.flag}">
                  <span>安全与投诉</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="safetousu.flag" class="detail">
           ...
           <li class="border-first">
              <p  @click="open(zjtjd)" :class="{'open-detail':zjtjd.flag}">
                  <span>是否可以增加途经地</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="zjtjd.flag" class="detail">
                 搬家订单系统默认为2个地址，如果您需要中间增加途经地，在司机服务过程中，直接和司机沟通即可。
                搬家订单增加途经地，需要额外支付50元的增加途经地的费用。
              </div>
          </li>
           <li>
              <p  @click="open(gstcf)" :class="{'open-detail':gstcf.flag}">
                  <span>高速费、停车费谁来付</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="gstcf.flag" class="detail">
                 所有由第三方收取的费用，如高速费、停车费均由您来承担。
              </div>
          </li>
          <li>
              <p  @click="open(fyzf)" :class="{'open-detail':fyzf.flag}">
                  <span>费用如何支付</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="fyzf.flag" class="detail">
          ...
          <li>
              <p  @click="open(ghdriver)" :class="{'open-detail':ghdriver.flag}">
                  <span>想要换司机怎么办</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="ghdriver.flag" class="detail">
                 当您遇到司机无法正常服务或司机迟到，可联系客服400-678-5966更换司机。
              </div>
          </li>
          <li class="border-second">
              <p  @click="open(lxdriver)" :class="{'open-detail':lxdriver.flag}">
                  <span>联系不上司机怎么办</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="lxdriver.flag" class="detail">
          ...
          <li class="border-first">
              <p  @click="open(bxbzfwsm)" :class="{'open-detail':bxbzfwsm.flag}">
                  <span>保险保障服务说明</span>
                  <span class="arrow"></span>
              </p>
              <div  v-show="bxbzfwsm.flag" class="detail">
