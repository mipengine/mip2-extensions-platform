...
<template>
    <div class="wrapper" >
        ...
        <div class="project">
            ...
            <div class="down">
                <ul>
                    <li v-for="e in ext" v-bind:id="e.id" @click="toserviceclass(e.id,e.name)"><img :src="e.iconUrl2"><i>{{e.name}}</i></li>
                </ul>
            </div>
        </div>
        <div class="box">
            <div v-for="k in list" >
                <div class="h2" v-bind:categoryId="k.categoryId">{{k.categoryName}}<span @click="toserviceclass(k.categoryId)" >更多<img src="https://www.daoway.cn/h5/image/go_06.png"></span></div>
                <ul class="item-name" >
                    <li v-for="t in k.items" @click="toservicedetail(t.id)" class="detailItem" v-bind:id="t.id">
                        <img class="liimg"
                             :src="t.pic_url">
        ...
        <mip-fixed type="bottom">
            <div class="bottomnav">
                <a class="regclolr" data-type="mip" data-title="首页" href="/components/mip-dw-index/example/mip-dw-index" @click="toindex"><img src="/common/images/home.png">首页</a>
        ...
        methods: {
            ...
            link(target){
                ...
                if (/openSuper/g.test(target)) {
                    ...
                    var temp = target.split("?tag=");
                    var tagName = temp[1] || '全部';
                    var catId = temp[0].split("app://entrance/openService/")[1];
