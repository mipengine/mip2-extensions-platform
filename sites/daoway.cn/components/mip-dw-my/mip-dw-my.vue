<template>
    <div class="wrapper">
        <div class="mybg" >
            <img  :src="userInfo.iconUrl?userInfo.iconUrl:'http://www.daoway.cn/images/myicon.png'" class="myicon">
            <div class="txt" v-if="userId">
        ...
        <div class="mylist" v-if="userInfo.couponCount" style='margin-top:0; border:0' @click="goVouchersPage" >
            <div class="item">
                <img src="http://www.daoway.cn/images/quan.png" class="cartimg" style="width:20px; height:20px">
                <div class="cart">代金券</div>
                <div class="carttel">{{userInfo.couponCount}}张<img class="m-more" src="https://www.daoway.cn/h5/image/go_06.png"></div>
            </div>
        </div>
        <div class="mylist">
            <div class="item" >
                <img src="http://www.daoway.cn/images/tel.png" class="cartimg"  style="width:20px; height:20px">
                <div class="cart">联系客服</div>
                <div class="carttel"><a href="tel:400-0908-608" rel="external">400-0908-608</a><img class="m-more" src="https://www.daoway.cn/h5/image/go_06.png"></div>
            </div>
        </div>
        <div class="mylist">
            <div class="item" @click="toabout">
                <img src="http://www.daoway.cn/images/about.png" class="cartimg"  style="width:20px; height:20px">
                <div class="cart">关于</div>
                <div class="carttel"><img class="m-more" src="https://www.daoway.cn/h5/image/go_06.png"></div>
            </div>
        </div>
        ...
        <mip-fixed type="bottom">
            <div class="bottomnav">
                ...
                <a data-type="mip" data-title="订单" href="/components/mip-dw-order/example/mip-dw-order"><img src="/common/images/order2.png">订单</a>
                <a class="regclolr" data-type="mip" data-title="我的" href="/components/mip-dw-my/example/mip-dw-my"><img src="/common/images/my.png">我的</a>
            </div>
        </mip-fixed>
        <!--提示-->
    ...
    export default {
        data(){
            return {
                ...
                iconUrl: '/common/images/myicon.png',
                couponCount: 0,
                userInfo:{},
                warn: {
                    // 弹窗
                ...
                redirect_uri:'http://test.daoway.cn/mip/components/mip-dw-my/example/mip-dw-my.html',
        ...
        methods: {
                ...
                fetch(url, {
                    ...
                    if(text.status == 'ok'){
                        ...
                        if (level == '100') {//青铜会员
                            ...
                            userInfo.levelIcon = '/common/images/p.png';
                        }
            ...
            goVouchersPage: function (){
                var miniUserId = base.userId || null;
                if (miniUserId) {
