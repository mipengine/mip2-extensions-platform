<template>
    <div class="mip-download-wrapper" v-if="status !== 'hidden'">
...
<script>
    export default {
        ...
        created() {
            this.doLog('pageview', {act: 'pageEnter', from: this.source, url: this.url});
        ...
        methods: {
            ...
            doLog(logtype, queryInfo = {}, headerInfo = {}) {
                ...
                queryInfo = Object.assign(queryInfo, {action: 'log', logtype: logtype, mip:'mip-download-safe'});
