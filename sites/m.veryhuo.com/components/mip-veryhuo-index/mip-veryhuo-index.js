...
export default class MIPMhotComment extends CustomElement {
  build () {
    ...
    var lm = '';
    let iosweb = document.getElementById("iosweb").getAttribute("value");//0是安卓 1是苹果
    ...
    console.log(type);
    let moreBtn = this.element.querySelector('#moreApp');   // 更多按钮
    let iList = this.element.querySelector('.Apply .iList');   // ul
    // 发送请求
    let p = 15;
    let doing = 0;
