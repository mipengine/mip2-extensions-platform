...
export default class MIPMhotComment extends CustomElement {
    build () {
        ...
        let lis = this.element.querySelectorAll('.hqnav i');    // 专题页 tab切换标题
        let uls = this.element.querySelectorAll('.speContent ul');   // 专题ul内容
        for (let i = 0; i < lis.length; i++) {
            ...
            lis[i].onclick = function () {
                ...
                this.className = 'cur';  //点击哪个按钮就哪个按钮加active类
