<template>
  <div class="search-box"> 
    <form class="search-input" action="https://mip.gushici.com/so.html">
      <input type="hidden" id="history" :value="old">
      <input type="text" name="value" id="inp" placeholder="在古诗词网中搜索" autocomplete="off" @focus="_focus" @input="_input">
      <i></i>
    </form>
    <div v-show="showResult" class="search-result">
      ...
      <p class="close" @click="_close">关闭搜索</p>
    </div>
  </div>
</template>
