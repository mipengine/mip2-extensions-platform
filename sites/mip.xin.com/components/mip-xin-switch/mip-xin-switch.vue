<template>
  <div class="tabWrap">
    <mip-xin-tab id="tab" :flaws="flaws" :paint="paint" v-if="flaws" 
   ...
   <!-- TODO:百度的swiper组件支持外部控制时，向子组件传参即可控制swiper的切换 -->
    ...
    <mip-xin-flawcount id="count" v-if="isShow&&swiperIndex == 0&& outerImgArr.length>0" :img-arr="outerImgArr" :current-index="currentOuterIndex"></mip-xin-flawcount>
    <mip-xin-flawcount id="count" v-if="isShow&&swiperIndex == 1&& innerImgArr.length>0" :img-arr="innerImgArr" :current-index="currentInnerIndex"></mip-xin-flawcount>
    <mip-xin-flawcount id="count" v-if="isShow&&swiperIndex == 2&& frameImgArr.length>0" :img-arr="frameImgArr" :current-index="currentFrameIndex"></mip-xin-flawcount>
    <mip-xin-flawcount id="count" v-if="!isShow&&paintIndex==0&&paintOuter.length>0" :img-arr="paintOuter"></mip-xin-flawcount>
    <mip-xin-flawcount id="count" v-if="!isShow&&paintIndex==1&&paintOuter.length>0" :img-arr="paintFrame"></mip-xin-flawcount>
     <div v-if="flaws">
