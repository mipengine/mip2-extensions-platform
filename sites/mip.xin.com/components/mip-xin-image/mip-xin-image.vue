<template>
  ...
  <div class="big-image-box" id="imgbox" @click="returnCardetail">
    <!-- <mip-fixed type="top" @click="hanldeHideMackClick"> -->
      ...
      <div class="bottom-content">
        ...
        <div class="askButton"><mip-xin-button :source='3' @changeNum="changeCurrentNum"  id="showindex" :car-info="carInfo" v-if="carInfo"></mip-xin-button></div>
      </div>
  <!-- </mip-fixed> -->
