    ...
    <mip-fixed type="top" id="callmaskSimilar" v-if="showToast && showSimilarToast"  @click="hideMask"  class="callMask">
      ...
      <div style="border-top: 0.12rem solid rgba(246, 246, 249, 1);" v-if="showList && carList.length > 0">
        ...
        <div style="max-height: 5rem;overflow: scroll;"> 
            <div class="similar-recommend-scroll" v-for="(item, index) in carList" :key="index">
            <div class="carcontent-scroll"  id="similarRecommend" :class="{'carcontent-bottom-scroll': index != carList.length-1}">
              <mip-img class="image-scroll" style="margin-left: 0.3rem; margin-right: 0.27rem;" :src=" item.pic" />
              <div class="contentright-scroll">
                <div class="righttop-scroll">
                  ...
                  <div class="pricedetail-scroll">
                    ...
                    <div v-if="item.isAsk && item.enquiry_status == 1" class="pricedetail-div-scroll" @click="askPriceOne(index)">一键询价</div>
                    <div v-if="!item.isAsk && item.enquiry_status == 1" class="asked-price-scroll">已询价</div>
                  </div>
                </div>
              </div>
            </div>
