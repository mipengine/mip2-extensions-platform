<template>
    <div>
      <!-- <mip-loading v-if="showLoading" :show-mask="showMaskBack"></mip-loading> -->
        <div class="certificationContent">
            <div class="bdline">
                ...
                <button class="car-ask"  @click="askPrice" v-if="status == 1">服务咨询</button>
            </div>
            <!-- <div class='car-set u-certified'> -->
            <div class="car-set-content">
                <div class="params-info"  @click="certified('1')">
                    <mip-img class="paramsIcon u-certified-img" src='http://c2.xinstatic.com/f3/20180515/1133/5afa550230779754988.png' />
                    <div>
                        <span class="u-certified-name ">30天包退</span>
                    </div>
                    <div class="car-certification-choiced" v-if="showList == '1'"></div>
                </div>
                <div class="params-info"  @click="certified('2')">
                    <mip-img class="paramsIcon u-certified-img" src='http://c2.xinstatic.com/f3/20180515/1139/5afa565b9b22c896559.png' />
                    <div>
                        <span class="u-certified-name ">一年保修</span>
                    </div>
                    <div class="car-certification-choiced"  v-if="showList == '2'"></div>
                </div>
                <div class="params-info"  @click="certified('3')">
                    <mip-img class="paramsIcon u-certified-img" src='http://c2.xinstatic.com/f3/20180515/1140/5afa56a0d3c6b900432.png' />
                    <div>
                        <span class="u-certified-name">315项排查</span>
                    </div>
                    <div class="car-certification-choiced"  v-if="showList == '3'"></div>
                </div>
                <div class="params-info"  @click="certified('4')">
                    <mip-img class="paramsIcon u-certified-img" src='http://c2.xinstatic.com/f3/20180515/1140/5afa56a0d9c63712615.png' />
                    <div>
                        <span class="u-certified-name">全国联保</span>
                    </div>
                    <div class="car-certification-choiced"  v-if="showList == '4'"></div>
                </div>
            </div>
            <!-- </div> -->
            <!-- 30天保修 -->
            <div class="car-exchange "  v-if="showList == '1'">
                ...
                <div class="car-certification-title">
                    ...
                    <div class="car-certification-message" @click="nextPage('big')">
                        <span>详情</span>
                        <div class="paramsArrow car-exchange-posi"></div>
                    </div>
                </div>
                <div class="car-exchange-content">
                    <div class="car-exchange-contentlist">
                        <div class="car-exchange-font"></div>
                ...
                <div class="car-exchange-process car-certification-title">
                    ...
                    <div class="car-certification-message"  @click="nextPage('progress')">
                        <span>详情</span>
                        <div class="paramsArrow car-exchange-posi"></div>
                    </div>
                ...
                <div class="car-exchange-step">
                    <div class="car-exchange-stepbox">
                        ...
                        <span class="paramsArrow car-exchange-position"></span>
                    </div>
                    <div class="car-exchange-stepbox">
                        <span class="car-exchange-stepno">②</span>
            ...
            <!-- 一年保修 -->
             <div class="car-exchange "  v-if="showList == '2'">
                <div class="car-exchange-summarize">
                ...
                <div class="car-exchange-process car-certification-title">
                    ...
                    <div class="car-certification-message"  @click="nextPage('component')">
                        <span>详情</span>
                        <div class="paramsArrow car-exchange-posi"></div>
                    </div>
                </div>
                <div class="car-unprofor-content">
                    <div class="car-unprofor-box">
                        <mip-img src='http://s3.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic1_1f2ad13.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">发动机系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s2.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic2_42b3bbe.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">变速箱系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s1.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic3_2417ea4.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">差速器系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s3.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic4_eaee618.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">分动箱系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s2.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic5_e43ec78.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">润滑系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s5.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic6_bd0e738.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">驱动系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s2.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic7_6af55a2.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">转向系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s5.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic8_ccc6464.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">制动系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s6.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic9_7e34707.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">悬挂系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s5.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic10_02895f1.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">燃油系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s1.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic11_cbeb301.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">冷却系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s4.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic12_93505a6.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">空调系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s2.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic13_a8877ed.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">安全系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s1.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic14_4a7d986.png' class="car-unprofor-font"/>
                        <span class="car-unprofor-desc">电控系统</span>
                    </div>
                    <div class="car-unprofor-box">
                        <mip-img src='http://s2.xinstatic.com/static/newcar-m/widget/car_detail/uxin/img/ic15_e77f88b.png' class="car-unprofor-font"/>
                ...
                <div class="car-exchange-process car-certification-title">
                    ...
                    <div class="car-certification-message"  @click="nextPage()">
                        <span>详情</span>
                        <div class="paramsArrow car-exchange-posi"></div>
                    </div>
                </div>
            ...
            <!-- 315项检查 -->
            <div class="car-exchange"  v-if="showList == '3'">
                <div class="car-exchange-summarize">
            ...
            <!-- 全国联保 -->
            <div class="car-exchange"  v-if="showList == '4'">
                <div class="car-exchange-summarize">
