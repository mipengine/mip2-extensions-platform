<template>
  <div class="wrapper">
    <mip-video  class="video" id="test" width="1000" height="750" layout="responsive" autoplay controls  poster="http://img.alicdn.com/tfs/TB1I3qqqrGYBuNjy0FoXXciBFXa-1125-807.jpg_970x970Q90s50.jpg_.webp">
