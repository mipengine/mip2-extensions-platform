<template>
  <div>
    ...
    <mip-swiper-position @changeNum="changeCurrentNum" :status="status" id="position" :show-play="big_image_info.is_video" :total="totalLenght.length" :carid="big_image_info.carid"></mip-swiper-position>
    <!-- <mip-big-image :carid="carid" :car-info="carInfo" :cityid="cityMessage.cityid" v-if="carInfo&&isHideMask" :current-index='this.currentIndex' @changeMask="handleHideMaskClick" :big-image="big_image_info.img_six" :price="price"></mip-big-image> -->
  </div>
</template>
