  ...
  <div class="wrapper">
     <mip-fixed type="top" class="listWrap" v-show="isFixed">
      ...
      <div v-if="isShowVideo">
          ...
          <mip-xin-video  id="test" :video-img="videoImg" :video-url="videoUrl" v-if="videoUrl&&videoImg"></mip-xin-video>
      </div>
      ...
      <mip-xin-button  :source="4" v-if="carid"></mip-xin-button>
      <div class="boxTop"></div>
          <div class="reportTitle lastTitle">
          <span class="title">瑕疵及修复</span>
      </div>
      <mip-xin-switch :carid="carid" v-if="carid" class="borderBottom"></mip-xin-switch>
  </div>
</template>
