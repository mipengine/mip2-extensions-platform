<template>
  <div style="padding-bottom:0.88rem">
    <div class="carcontent" :class="{'carcontent-bottom':index != similarCar.length-1  }" v-for="(item,index) in similarCar" :key="index" @click="gotoDetail(item.detail_url,index)">
      <div class="content-left">
        ...
        <mip-img class="carpic" :src="item.pic"></mip-img>
        <mip-img class="play" v-if="item.is_video == 1" src="http://c2.xinstatic.com/f3/20180323/1111/5ab470517f150445829.png"></mip-img>
      </div>
      <div class="content-right">
        ...
        <div class="pricedetail">
          <span class="percent" v-if="item.is_ycg_car == 1">一成购</span>
