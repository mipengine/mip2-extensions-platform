<template>
  <div class="area">
      ...
      <div class="detail flex">
        ...
        <input type="text" class="content"  v-model="detail" placeholder="输入详细的街道，小区，大厦等" @focus="focus"  @input="search" @blur="blur" :class="{right1:wrong2}">
      </div>
               ...
               let geolocation = new BMap.Geolocation();
                geolocation.getCurrentPosition(function(r){
                    ...
                    geoc.getLocation(r.point,function(rs){
                        ...
                        _this.area.city = rs.addressComponents.city
