<template>
  <mip-fixed
    ...
    <div class="bot_bar">
      ...
      <div
        :href="linkHref"
        class="link_btn">打开</div>
      <div
        data-stats-baidu-obj="%7B%22type%22%3A%22click%22%2C%22data%22%3A%5B%22_trackEvent%22%2C%22zongheng%22%2C%22download%22%5D%7D"
...
export default {
  ...
  methods: {
    _close () {
      ...
      // 点击关闭按钮的统计
      // _hmt && _hmt.push(['_trackEvent', 'zonghengbotbar', 'close', 'click']);
    },
    _jumpDownload () {
      // 统计点击去下载的次数
      // _hmt && _hmt.push(['_trackEvent', 'zonghengbotbar', 'todownload', 'click']);
    }
  },
  firstInviewCallback () {
    // console.log(_hmt)
    // 第一次进入统计有多少展现
    // _hmt.push(['_trackEvent', 'zonghengbotbar', 'firstin', 'autoinit']);
  }
}
</script>
