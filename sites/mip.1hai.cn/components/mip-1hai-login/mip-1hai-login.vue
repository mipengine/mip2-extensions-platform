    ...
    <div class="mod panel">
      <div class="phone item border-bottom-px1">
        <div class="icon item-hd">
          <mip-img src="/static/image/phone_grey.png"/>
        </div>
      ...
      <div class="code item border-bottom-px1">
        <div class="icon item-hd">
          <mip-img src="/static/image/code_grey.png"/>
        </div>
        ...
        <div
          ...
          class="ui-btn btn-xs btn-primary2 ui-hide"
          @click="getVerityCode"
        >获取验证码</div>
        <div
          v-show="showCountDown"
          class="ui-btn btn-xs btn-default ui-hide">{{ count }}秒后重发</div>
      </div>
    </div>
