    ...
    <div class="panel-new">
      <div class="panel-new-bd">
        <div class="ui-flex align-start list-item">
          <div
            class="cell list-item-pickup"
            data-type="0"
            @click="chooseCity">
            <div class="gray">取车城市</div>
            <div
              v-if="!pickUpCity.Name"
              class="gray">请选择城市</div>
            <div v-if="pickUpCity.Name">{{ pickUpCity.Name }}</div>
          </div>
          <div
            class="cell list-item-dropoff"
            data-type="1"
            @click="chooseCity" >
            <div class="gray">还车城市</div>
            <div
              v-if="!dropOffCity.Name"
              class="gray">请选择城市</div>
        ...
        <div class="ui-flex align-start list-item">
          <div
            class="cell list-item-pickup"
            data-type="0"
            data-city-id="pickUpCity.Id"
            data-city-name="pickUpCity.Name"
            @click="chooseStore"
          >
            <div class="gray">取车门店</div>
            <div
              v-if="!pickUpStore.Name"
              class="gray">请选择门店</div>
            <div v-if="pickUpStore.Name">{{ pickUpStore.Name }}</div>
          </div>
          <div
            class="cell list-item-dropoff"
            data-type="1"
            data-city-id="dropOffCity.Id"
            data-city-name="dropOffCity.Name"
            @click="chooseStore"
          >
            <div class="gray">还车门店</div>
            <div
              v-if="!dropOffStore.Name"
              class="gray">请选择门店</div>
