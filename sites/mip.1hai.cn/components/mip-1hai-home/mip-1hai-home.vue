<template>
  <section class="new-home" main="role">
    <div class="banner-scroll">
      <!-- <mip-carousel layout="responsive" width="750" height="342" autoplay defer="3000" indicatorId="mip-carousel-example">
        <mip-img v-for="item in listData" :key="item.Id" :data-src="item.ImageUrl" :src="item.ImageUrl" data-was-processed="true">
        </mip-img>
      </mip-carousel> -->

      <mip-carousel layout="responsive" width="750" height="342" autoplay defer="3000" indicatorId="mip-carousel-example">
        <mip-img src="https://image.1hai.cn/images/News/20180419/ffedb84c-9d8e-40bf-9aa8-89ee3746b3d0.jpg">
        </mip-img>
      </mip-carousel>
    ...
    <div class="navigater">
      <div class="ng-mod">
        <a data-type="mip" data-title="自驾租车" href="step1.html" class="icon-booking">
          <span class="icon"></span>
          <p>自驾租车<span>百款车型 千个网点</span></p>
        </a>
        <a data-type="mip" data-title="我的一嗨" href="my.html" class="icon-my">
          <span class="icon"></span>
          <p>我的一嗨<span>&nbsp;</span></p>
        </a>
      </div>
    ...
    <div class="footer">
      <a data-type="mip" data-title="联系客服" href="tel:4008886608">联系客服</a>
