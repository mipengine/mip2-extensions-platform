  ...
  <section main="role">
    ...
    <div class="mod order-success">
      <div class="ui-flex-colum-wrap align-center justify-center order-success-title">
        <div class="cell icon-m icon-success"></div>
      ...
      <div class="order-success-total text-center">
        <span class="orange">订单金额<span class="rmb">¥</span>{{totalPrice}}</span>
      </div>
    </div>

    <div class="btn-lg-wrap">
      <div class="ui-btn btn-block btn-lg btn-primary2" @click="ordersManage">订单管理</div>
      <div class="ui-btn btn-block btn-lg btn-primary2" v-if="paymentType === 10119005" @click="payOrder">立即支付</div>
    </div>
