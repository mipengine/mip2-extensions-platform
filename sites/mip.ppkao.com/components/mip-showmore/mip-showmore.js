 ...
 */
import './index.less'
export default class MIPShowmore extends MIP.CustomElement {
  build () {
    ...
    */
    ...
    Showmore.prototype._initTextLength = function () {
      ...
      // 获取剪切后的字符串
      let cutOffText = this._cutHtmlStr(this.maxLen)
    ...
    */
    ...
    customElement.prototype.build = function () {
      ...
      let showmoreObj = new Showmore(ele)
      showmoreObj.init()
