<template>
  <div class="num-pay">
    ...
    <div class="dx-data-content dx-pay-money">
...
export default {
  ...
  methods: {
    initData () {
      ...
      const decisionPayParams = Storage.get('decisionPayParams') || null
      if (memberSimpleInfo) {
        self.isMember = memberSimpleInfo.isMember
      }
      if (decisionPayParams) {
        self.decisionPayParams = decisionPayParams
        self.totalFee = decisionPayParams.totalFee
        self.discountFee = decisionPayParams.beforeDiscount - decisionPayParams.totalFee
      }
    },
    toPay () {
      let self = this
      ...
      MIP.setData({
        payConfig: {
          ...
          subject: self.decisionPayParams.orderName,
          postData: {
