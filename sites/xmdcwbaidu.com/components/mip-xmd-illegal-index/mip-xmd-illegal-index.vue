<template>
  <div class="illegal-index">
    ...
    <div v-if="isShowNoticeTip" class="ldf-business-tips">
      <p>
        <mip-img
          layout="container"
          src="../static/img/business-tips.png" alt="">
        </mip-img>
      </p>
...
import lineContent from '../../common/components/lineContent'
import mtPopup from '../../common/components/popup'
import selectBox from '../../common/components/pdSelect/selectBox'
import selectItem from '../../common/components/pdSelect/selectItem'
import loginBecomeMember from '../../common/components/loginBecomeMember'
