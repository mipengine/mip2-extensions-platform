  ...
  <div class="content-page">
    ...
    <mip-fixed
      ...
      <div class="bottom-popup" >
        ...
        <div
          v-show="content.show.isShowDescription"
...
.content-page {
  ...
  .ticket-tag {
    ...
    &.delivery {
      background: url(~@/static/icon/assurance-delivery.png) no-repeat left
        center;
      background-size: 16px 16px;
    }
    &.vr {
  ...
  .content-detail {
    ...
    .advertising {
      padding: 1.8rem;
      .content-detail {
        background: url(~@/static/icon/show-advertisement.png) no-repeat 18px
          18px;
...
.content-footer {
  ...
  .customer-service {
    ...
    .icon {
      background: url(~@/static/icon/customer-service.png) center center
        no-repeat;
