    ...
    <div class="titbg">
      <div class="tit clearfix">
        <div class="tit-left fl pr">
          <i class="dian abs"></i>新增地址</div>
      </div>
    </div>
    <div class="bot clearfix">
      <div class="bot-nr clearfix">
        <div class="bot-nr-l fl">收 货 人：</div>
        <input type="text" name="fullName" v-model="postInfo.fullName" class="bot-nr-c fl">
      </div>
      <div class="bot-nr clearfix">
        <div class="bot-nr-l fl">手机号码：</div>
        <input type="text" name="fullName" v-model="postInfo.mobile" class="bot-nr-c fl">
      </div>
      <div class="bot-nr clearfix">
        <div class="bot-nr-l fl">邮&#12288;&#12288;编：</div>
        <input type="text" name="fullName" v-model="postInfo.zipcode" class="bot-nr-c fl">
      </div>
      <div class="bot-nr clearfix">
        <div class="bot-nr-l fl">邮&#12288;&#12288;箱：</div>
        <input type="text" name="fullName" v-model="postInfo.email" class="bot-nr-c fl">
      </div>
      <div class="bot-nr clearfix pr">
        <div class="bot-nr-l fl">所在地区：</div>
        <div class="bot-nr-c3 fl" on="click:addressPicker.initPicker">
          <label id="cityData" v-if="flag" v-text="readyArea.province.name + ' ' + readyArea.city.name + ' ' + readyArea.area.name"></label>
        </div>
        <i class="rjian abs"></i>
      </div>
      <div class="bot-nr clearfix">
        <div class="bot-nr-l fl">详细地址：</div>
        <textarea name="fullName" v-model="postInfo.address" class="bot-nr-c2 fl" placeholder="请输入街道、楼牌号等"></textarea>
      </div>
    </div>
    <button class="han" @click="savePostInfo">保存并使用</button>
