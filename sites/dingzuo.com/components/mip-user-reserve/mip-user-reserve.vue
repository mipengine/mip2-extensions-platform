<template type="mip-mustache">
  <div class="mip-reserve">
    ...
    <div class="usermes">
      <div class="name-sex">
        <div class="sex">
          <span
            :class="isSex?&quot;select&quot;:&quot;&quot;"
            @click="isSex=true">男</span><span
              :class="isSex?&quot;&quot;:&quot;select&quot;"
              @click="isSex=false">女</span>
        </div>
        <div
          :class="isIncompleteN?&quot;&quot;:&quot;incomplete&quot;"
          class="name">
          <span>
            <mip-img
              :src="username"
      ...
      <div
        :class="isIncompleteP?&quot;&quot;:&quot;incomplete&quot;"
        class="phone">
        <span>
          <mip-img
            :src="userphone"
    ...
    <ul class="label"><li
      ...
      :key="label.id"
      @click="selectRemark">{{ label }}</li></ul>
    ...
    <mip-fixed
      class="pay"
      @click="toJump">有座，马上预定</mip-fixed>
  </div>
</template>
...
export default {
  ...
  mounted () {
    ...
    // 修改今天和明天的日期显示格式
    if (Number(this.orderDate) === date.getDate()) {
      this.orderMonth = '今'
    } else if (Number(this.orderDate) === date.getDate() + 1) {
      this.orderMonth = '明'
    } else {
